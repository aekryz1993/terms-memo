...
import type { PaginationLoaderData } from "~/types/data";

export const Pagination = () => {
  const { totalPages, currentPage, take } =
    useLoaderData<PaginationLoaderData>();

  return (
    <Container id="sets-pagination" classes={paginationRoot}>
